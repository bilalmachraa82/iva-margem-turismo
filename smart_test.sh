#!/bin/bash
# Smart testing script with automatic retry and detailed diagnostics
...
echo -e "${BLUE}🧠 SMART TEST SUITE - IVA Margem Turismo${NC}"
echo "========================================"
...
test_backend() {
    ...
    if check_port 8000; then
        ...
        if pgrep -f "uvicorn app.main:app" > /dev/null; then
            ...
            echo "cd backend && python3 -m uvicorn app.main:app --reload --host 0.0.0.0"
        fi
        return 1
    fi
}
